...
$certificado_path = '../certificados/certificado_' . $id . '.pdf';

// // Leer el contenido del archivo PDF en formato base64
$certificado_base64 = base64_encode(file_get_contents($certificado_path));
        ...
        'components' => [
            [
                ...
                'parameters' => [
                    [
                        'type' => 'text',
                        'text' => 'Adjunto te enviamos tu certificado.'
                    ],
                    [
                        'type' => 'file',
                        'file' => [
