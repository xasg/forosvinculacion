              ...
              <div class="col-md-12">
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="nav-item">
                                       ...
                                       <li class="nav-item">
                                        <a class="nav-link active" href="asistencia.php">Asistencia general</a>
                                      </li>
                                      <li class="nav-item">
                                           ...
                                           <?php
                                             $counter = 1;
                                              ...
                                              <tr style="border-bottom:0px">  
                                                ...
                                                <td><?php echo $asis['dt_email']."<br>Tel. Institucional:"." ".$asis['telefono']."<br>Movil.: "." ".$asis['celular'];;?></td>
                                                 <td>
                                                 ...
                                                 <td><?php echo $asis['mesa']; ?></td>
                                                  <td><?php echo $asis['tipo']; ?></td>
                                                 <td>Asistente general</td>
                                                 <td><?php echo $asis['dt_participacion']; ?></td>
                                              </tr> 
