                      ...
                      <div class="col-md-12">
                                 <ul class="nav nav-tabs">
                                      <li class="nav-item">
                                       ...
                                       <li class="nav-item">
                                        <a class="nav-link" href="mesas/sur_sureste.php">SUR SURESTE</a> 
                                        </li>
                                      <li class="nav-item">
                                        <a class="nav-link" href="mesas/cdmx.php">CDMX Y ZONA METROPOLITANA</a>
                                      </li>
                                       <li class="nav-item">
                                        <a class="nav-link " href="mesas/bajio.php">BAJIO OCCIDENTE</a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link" href="mesas/frontera.php">FRONTERA NORTE</a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link" href="mesas/noroeste.php">NOROESTE</a>
                                      </li>
                                  </ul><br><br>
                      </div>
...
<table class="table table-bordered">
  <thead>
    <tr>
      <th scope="col"><h4>Región</h4></th>
      <th scope="col" class="text-center"><h4># Registros</h4></th>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    ?>
    <tr>
      <th scope="row"><?php echo $res['dt_nombre_region']; ?></th>
