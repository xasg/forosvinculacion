...
<html lang="es">
   <head>
      ...
      <title>Registro Mesas de trabajo</title>
                     ...
                     <div class="row ">  
                      ...
                      <div class="col-md-12">
                                 <ul class="nav nav-tabs">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link active" href="cdmx.php">CDMX Y ZONA METROPOLITANA</a>
                                      </li>
                                       <li class="nav-item">
                                        <a class="nav-link " href="bajio.php">BAJIO OCCIDENTE</a>
                                      </li>
                                      <li class="nav-item">
...
<div class="row ">  
<div class="col-md-12">
  <h3>MESAS DE TRABAJO CDMX Y ZONA METROPOLITANA</h3><br><br>
</div>
<div class="col-md-6">
     ...
     <?php
                                             while($du = $dualreg->fetch_assoc())
                                              ...
                                              <tr style="border-bottom:0px">
                                                <td><?php echo $du['dt_nombre_mesa']; ?></td>
                                                <td class="text-center"><?php echo $du['total']; ?></td>  
                                              </tr> 
