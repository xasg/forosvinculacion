...
// if ($_POST) {
    ...
    if ($whatsapp_cloud_api->sendTemplate($numero_WPAPI, $regiol_WPAPI, 'en_US') && $whatsapp_cloud_api->sendTextMessage($numero_WPAPI, "Tu folio es: *$id_user*\nCorreo Asociado: $d_email")) {
