                  ...
                  <div class="card-body p-md-5 mx-md-4 ">
                    ...
                    <form action="controller/recuperar_folio.php" method="POST">
                      ...
                      <div class="text-center pt-1 mb-5 pb-1">
                        <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" style="border-radius: 22px; border: 1px solid #4f2550; box-shadow:-1px 2px 5px #10312B;" type="submit">Recuperar Folio</button>                        <br>
